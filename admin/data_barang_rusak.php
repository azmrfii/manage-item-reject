...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <a href="cetak1.php" class="btn btn-success">Cetak Semua Data</a><br>
            <div class="card-body">
                <table class="table" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="cetak-admin1.php?cetak&id=<?php echo $data['id_barang']?>" class="btn btn-success">Cetak</a></td>
                        </tr>
                        <?php
                            }
                        ?>
